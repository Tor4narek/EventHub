        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventStatus = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsWeeklyDigestEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    LastWeeklyDigestAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_Deadline",
                table: "Events",
                column: "Deadline");

            migrationBuilder.CreateIndex(
                name: "IX_Events_EventStatus_EventDateTime_Id",
                table: "Events",
                columns: new[] { "EventStatus", "EventDateTime", "Id" });
